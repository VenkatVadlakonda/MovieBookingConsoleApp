...
//                 .HasConstraintName("FK__Bookings__ShowID__403A8C7D");
...
//         {
//             entity.HasKey(e => e.ShowId).HasName("PK__ShowTimi__6DE3E0D23C36348B");

//             entity.Property(e => e.ShowId).HasColumnName("ShowID");
//             entity.Property(e => e.MovieId).HasColumnName("MovieID");

//             entity.HasOne(d => d.Movie).WithMany(p => p.ShowTimings)
//                 .HasForeignKey(d => d.MovieId)
//                 .HasConstraintName("FK__ShowTimin__Movie__3C69FB99");
//         });
